                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <ul style="text-align:justify; padding:0">
                                            ...
                                            <li>
                                                <p style="margin:0">Osmond Haylim<br>(140810200022)</p>
                                            </li>
                                            <li>
                                                <p style="margin:0">Rheza Pandya Andhikaputra<br>(140810200023)</p>
                                            </li>
                                            <li>
                                                <p style="margin:0">Andyka Baswara Putra<br>(140810200061)</p>
                                            </li>
                                        </ul>
                                    </div>
